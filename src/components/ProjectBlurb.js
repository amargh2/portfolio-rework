...
const Blurb = () => {
  return (
    <div className="flex justify-center px-10">
      <div className = 'header bg-gradient-to-tr from-blue-100 to-red-100 flex flex-col items-center py-4 text-slate-800 shadow-lg md:mx-40 mx-20 rounded-lg bg-white justify-center'>
          ...
          <div className="flex-col lg:flex-row items-center flex justify-center">
            ...
            <div className="flex gap-2 justify-center items-center flex-col">
              <p className="py-2 text-center inline-block prose">
