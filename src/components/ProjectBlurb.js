...
const Blurb = () => {
  return (
    <div className="flex justify-center">
      <div className = 'header bg-gradient-to-tr from-blue-100 to-red-100 flex flex-col items-center py-4 text-slate-800 shadow-lg w-3/4 md:mx-40 rounded-lg bg-white justify-center pt-10'>
