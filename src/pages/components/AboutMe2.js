          ...
          <div className="flex-col /lg:flex-row items-center flex justify-center">
            ...
            <div className="flex gap-2 py-2 justify-center items-center flex-col">
              <p className="py-2 text-center mx-10 inline-block"> 
                ...
                <p className="py-2 text-center mx-10 inline-block">
                After my time in Korea, I wanted to backpack through South America after some of my friends in Korea told me about their trips there. 
                ...
                an awesome hotel in a beautiful park staffed by some great people - and I also took some time to drive around 
                ...
                taking care of folks on their journeys in small, direct ways - and sometimes in big ways, depending on how the day turned out! 
                ...
                plugging away at it since. I love the mix of creative and technical skills coding requires, and I'm doing my best to improve on 
                those still-nascent skills every day.  </p>
                <p className='py-2 text-center mx-10 inline-block'>
                ...
                hopping on airplanes when the loads are light.</p>
                <p className='py-2 text-center mx-10 inline-block'> 
                ...
                and I hope you do too! And of course, if you'd like to work together, please don't hesitate to reach out. </p> 
            </div>
          </div>
      </div>
    </div>
